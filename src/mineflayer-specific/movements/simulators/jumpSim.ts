import { BotcraftPhysics, EntityPhysics } from '@nxg-org/mineflayer-physics-util/dist/physics/engines'
...
export class JumpSim extends BaseSimulator<PlayerState> {
  ...
  constructor (public readonly physics: BotcraftPhysics, world: World) {
    super(physics)
    this.world = world
  }
