...
class MovementExecutor extends movement_1.Movement {
    ...
    constructor(bot, world, settings = {}) {
        ...
        this.engine = new mineflayer_physics_util_1.EntityPhysics(bot.registry);
    ...
    isInitAligned(thisMove, target = thisMove.entryPos) {
        ...
        const bb0 = mineflayer_util_plugin_1.AABBUtils.getEntityAABBRaw({ position: normPos, width: 0.6, height: 1.8 });
        ...
        if (bb2.length === 0)
            bb2.push(mineflayer_util_plugin_1.AABB.fromBlock(bb2bl.position));
        ...
        if ((bb1.some((b) => b.collides(bb0)) && bb1good) || (bb2.some((b) => b.collides(bb0)) && bb2good)) {
            if (similarDirection)
                ...
                if (this.bot.entity.position.xzDistanceTo(target) < 0.2)
                    return true;
                if (bb2.some((b) => b.collides(bb0)) && bb2good)
                    return true;
            }
        }
        return false;
    ...
    postInitAlignToPath(startMove, endMove, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            (0, controls_1.botStrafeMovement)(this.bot, endMove.exitPos);
